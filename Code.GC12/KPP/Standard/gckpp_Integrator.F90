...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE Rosenbrock_1(N,Y,VAR_deleted,Tstart,Tend, &
           AbsTol,RelTol,              &
           RCNTRL,ICNTRL,RSTATUS,ISTATUS,IERR)
...
!~~~>  Arguments
   ...
   REAL(kind=dp), INTENT(IN)    :: VAR_deleted(LU_NDEL_1)
...
#else
   REAL(kind=dp) :: Jac0(LU_NONZERO_1), Ghimj(LU_NONZERO_1)
#endif
...
!~~~>   Compute the function at current time
   CALL FunTemplate_1(T,Y,Fcn0,VAR_deleted)
...
!~~~>   Compute the Jacobian at current time
   CALL JacTemplate_1(T,Y,Jac0, VAR_deleted)
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         CALL FunTemplate_1(Tau,Ynew,Fcn,VAR_deleted)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
...
!~~~> Local variables
   ...
   CALL FunTemplate_1(T+Delta,Y,dFdT,VAR_deleted)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
...
#else
   REAL(kind=dp), INTENT(IN) ::  Jac0(LU_NONZERO_1)
#endif   
...
#else
   REAL(kind=dp), INTENT(OUT) :: Ghimj(LU_NONZERO_1)
#endif   
...
!~~~>    Construct Ghimj = 1/(H*gam) - Jac0
     ...
     END DO
#else
     !slim: CALL WCOPY(LU_NONZERO_1,Jac0,1,Ghimj,1)
     !slim: CALL WSCAL(LU_NONZERO_1,(-ONE),Ghimj,1)
     Ghimj(1:LU_NONZERO_1) = -Jac0(1:LU_NONZERO_1)
     ghinv = ONE/(Direction*H*gam)
     DO i=1,N
       Ghimj(LU_DIAG_1(i)) = Ghimj(LU_DIAG_1(i))+ghinv
     END DO
#endif   
...
#else   
   REAL(kind=dp), INTENT(INOUT) :: A(LU_NONZERO_1)
#endif
!~~~> Output variables
...
!~~~> Input variables
   ...
   INTEGER :: ISING
#else   
   REAL(kind=dp), INTENT(IN) :: A(LU_NONZERO_1)
#endif
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
END SUBROUTINE Rosenbrock_1
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_1(T, Y, Ydot,VAR_deleted )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 REAL(kind=dp),INTENT(IN)::VAR_deleted(LU_NDEL_1)
!~~~> Input variables
   REAL(kind=dp) :: T, Y(LU_NSEL_1)
!~~~> Output variables
   REAL(kind=dp) :: Ydot(LU_NSEL_1)
!~~~> Local variables
   REAL(kind=dp) :: Told

   Told = TIME
   TIME = T
   CALL Fun_1( Y,VAR_deleted, FIX, RCONST, Ydot )
   TIME = Told

END SUBROUTINE FunTemplate_1


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE JacTemplate_1( T, Y, Jcb, VAR_deleted )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Output variables
#ifdef FULL_ALGEBRA    
    REAL(kind=dp) :: JV(LU_NONZERO_1), Jcb(LU_NSEL_1,LU_NSEL_1)
#else
    REAL(kind=dp) :: Jcb(LU_NONZERO_1)
#endif   
!~~~> Local variables
    REAL(kind=dp) :: Told
#ifdef FULL_ALGEBRA    
    ...
    TIME = T
#ifdef FULL_ALGEBRA    
    CALL Jac_SP_1(Y,VAR_deleted, FIX, RCONST, JV)
    DO j=1,LU_NSEL_1
      DO i=1,LU_NSEL_1
         Jcb(i,j) = 0.0_dp
      END DO
    END DO
    DO i=1,LU_NONZERO_1
       Jcb(LU_IROW_1(i),LU_ICOL_1(i)) = JV(i)
    END DO
#else
    CALL Jac_SP_1( Y, VAR_deleted, FIX, RCONST, Jcb )
#endif   
    TIME = Told
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE Rosenbrock_7(N,Y,VAR_deleted,Tstart,Tend, &
           AbsTol,RelTol,              &
           RCNTRL,ICNTRL,RSTATUS,ISTATUS,IERR)
...
!~~~>   Compute the function at current time
   CALL FunTemplate_7(T,Y,Fcn0,VAR_deleted)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL FunTemplate_7(Tau,Ynew,Fcn,VAR_deleted)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
       END IF ! if istage == 1 elseif ros_NewF(istage)
       !slim: CALL WCOPY(N,Fcn,1,K(ioffset+1),1)
       K(ioffset+1:ioffset+N) = Fcn(1:N)
...
!~~~> Local variables
   ...
   Delta = SQRT(Roundoff)*MAX(DeltaMin,ABS(T))
   CALL FunTemplate_7(T+Delta,Y,dFdT,VAR_deleted)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   CALL WAXPY(N,(-ONE),Fcn0,1,dFdT,1)
   CALL WSCAL(N,(ONE/Delta),dFdT,1)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_7(T, Y, Ydot,VAR_deleted )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_7( Y,VAR_deleted, FIX, RCONST, Ydot )
   TIME = Told
...
SUBROUTINE INTEGRATE_19( TIN, TOUT, &
  ...
  ICNTRL_U, RCNTRL_U, ISTATUS_U, RSTATUS_U, IERR_U )
   ...
   CALL Rosenbrock_19(LU_NSEL_19,VAR,TIN,TOUT,ATOL,RTOL,&
          RCNTRL,ICNTRL,RSTATUS,ISTATUS,IERR)		
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE Rosenbrock_19(N,Y,Tstart,Tend, &
           AbsTol,RelTol,              &
           RCNTRL,ICNTRL,RSTATUS,ISTATUS,IERR)
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL FunTemplate_19(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
       END IF ! if istage == 1 elseif ros_NewF(istage)
       !slim: CALL WCOPY(N,Fcn,1,K(ioffset+1),1)
       K(ioffset+1:ioffset+N) = Fcn(1:N)
...
!~~~> Local variables
   ...
   Delta = SQRT(Roundoff)*MAX(DeltaMin,ABS(T))
   CALL FunTemplate_19(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   CALL WAXPY(N,(-ONE),Fcn0,1,dFdT,1)
   CALL WSCAL(N,(ONE/Delta),dFdT,1)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_19( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_19( Y, FIX, RCONST, Ydot, LU_NSEL_19 )
   TIME = Told
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE JacTemplate_19( T, Y, Jcb )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE Jacobian call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Local variables
    ...
    TIME = T
#ifdef FULL_ALGEBRA    
    CALL Jac_SP_19(Y, FIX, RCONST, JV)
    DO j=1,LU_NSEL_19
      DO i=1,LU_NSEL_19
         Jcb(i,j) = 0.0_dp
      END DO
    ...
    END DO
#else
    CALL Jac_SP_19( Y, FIX, RCONST, Jcb)
#endif   
    TIME = Told
