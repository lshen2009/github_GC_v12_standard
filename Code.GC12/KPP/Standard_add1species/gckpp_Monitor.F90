...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'CHBr3          ','ICl            ','IMAO3          ', & ! index 73 - 75
     'CHCl3          ','MPN            ','Cl2O2          ', & ! index 76 - 78
     'CH2Br2         ','CH2Cl2         ','ETP            ', & ! index 79 - 81
     'HCFC123        ','ClNO2          ','HCFC141b       ', & ! index 82 - 84
     'IONO           ','HCFC142b       ','HCFC22         ', & ! index 85 - 87
     'OIO            ','RA3P           ','RB3P           ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_1 = (/ &
     ...
     'HOI            ','IAP            ','HPC52O2        ', & ! index 112 - 114
     'VRP            ','ATOOH          ','HC187          ', & ! index 115 - 117
     ...
     'INPN           ','C2H6           ','MTPA           ', & ! index 133 - 135
     'MTPO           ','NPMN           ','IONO2          ', & ! index 136 - 138
     ...
     'MGLOO          ','A3O2           ','CH2OO          ', & ! index 163 - 165
     'PROPNN         ','MAN2           ','ISNOOA         ', & ! index 166 - 168
     'PO2            ','B3O2           ','ISOPNDO2       ', & ! index 169 - 171
     'MACROO         ','R4N1           ','MACRN          ', & ! index 172 - 174
     'ISOP           ','H2O2           ','MAOPO2         ', & ! index 175 - 177
     'ATO2           ','HCOOH          ','I              ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(60) :: SPC_NAMES_2 = (/ &
     'RCO3           ','LIMO2          ','IO             ', & ! index 181 - 183
     'OLND           ','OLNN           ','KO2            ', & ! index 184 - 186
     'HOBr           ','ISOPNBO2       ','PIO2           ', & ! index 187 - 189
     'HC5OO          ','HNO3           ','ISOPND         ', & ! index 190 - 192
     'GLYC           ','NMAO3          ','ACTA           ', & ! index 193 - 195
     'VRO2           ','HOCl           ','ISN1           ', & ! index 196 - 198
     'ClNO3          ','MGLY           ','ACET           ', & ! index 199 - 201
     'HC5            ','RIO2           ','INO2           ', & ! index 202 - 204
     'ETO2           ','R4O2           ','R4N2           ', & ! index 205 - 207
     'HAC            ','MRO2           ','BrO            ', & ! index 208 - 210
     'PRPE           ','RCHO           ','MEK            ', & ! index 211 - 213
     'CH2O           ','MACR           ','ALD2           ', & ! index 214 - 216
     'MVK            ','MCO3           ','SO2            ', & ! index 217 - 219
     'CO             ','MO2            ','O3             ', & ! index 220 - 222
     'NO             ','Br             ','O              ', & ! index 223 - 225
     'HO2            ','Cl             ','NO3            ', & ! index 226 - 228
     'OH             ','H2O            ','NO2            ', & ! index 229 - 231
     'O1D            ','ClO            ','HCl            ', & ! index 232 - 234
     'HBr            ','H2             ','MOH            ', & ! index 235 - 237
     'N2             ','O2             ','RCOOH          ' /)
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_0 = (/ &
     '        LSHENA --> O2                                                                               ', & ! index 1
     '       O3 + NO --> NO2 + O2                                                                         ', & ! index 2
     '       O3 + OH --> LOx + HO2 + O2                                                                   ', & ! index 3
     '      O3 + HO2 --> LOx + OH + 2 O2                                                                  ', & ! index 4
     '      O3 + NO2 --> NO3 + O2                                                                         ', & ! index 5
     '      MO2 + O3 --> LOx + CH2O + HO2 + O2                                                            ', & ! index 6
     '          2 OH --> POx + O + H2O                                                                    ', & ! index 7
     '          2 OH --> H2O2                                                                             ', & ! index 8
     '      HO2 + OH --> H2O + O2                                                                         ', & ! index 9
     '     H2O2 + OH --> HO2 + H2O                                                                        ', & ! index 10
     '      NO + HO2 --> POx + OH + NO2                                                                   ', & ! index 11
     '         2 HO2 --> H2O2 + O2                                                                        ', & ! index 12
     '       CO + OH --> CO2 + LCO + HO2                                                                  ', & ! index 13
     '      CH4 + OH --> LCH4 + MO2 + H2O                                                                 ', & ! index 14
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '     R4O2 + NO --> POx + 0.05 A3O2 + 0.18 B3O2 + 0.32 ACET + 0.32 ETO2 + 0.14 RCHO + 0.19 MEK + 0.32', & ! index 52
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     ...
     '    A3O2 + MO2 --> 0.25 ROH + 0.75 RCHO + 0.75 CH2O + HO2 + 0.25 MOH                                ', & ! index 96
     '     PO2 + MO2 --> 0.25 ROH + 0.16 HAC + 0.09 RCHO + 1.25 CH2O + 0.5 ALD2 + HO2 + 0.25 MOH          ', & ! index 97
     ...
     '    VRO2 + HO2 --> 0.1 VRP + 0.578 GLYC + 0.102 MGLY + 0.033 RCHO + 0.187 MEK + 0.102 CH2O + 0.578 M', & ! index 103
     ...
     '     MEK + NO3 --> LOx + KO2 + HNO3                                                                 ', & ! index 111
     '    R4O2 + MO2 --> 0.25 ROH + 0.03 A3O2 + 0.09 B3O2 + 0.16 ACET + 0.16 ETO2 + 0.07 RCHO + 0.35 MEK +', & ! index 112
     '    R4N1 + MO2 --> 0.25 ROH + 0.15 R4O2 + 0.54 RCHO + 0.95 CH2O + 0.38 ALD2 + 0.5 HO2 + NO2 + 0.25 M', & ! index 113
     '    ATO2 + MO2 --> 0.5 MGLY + 0.2 HAC + 0.5 CH2O + 0.3 MCO3 + 0.3 HO2 + 0.5 MOH                     ', & ! index 114
     '     KO2 + MO2 --> 0.25 ROH + 0.25 MEK + 0.75 CH2O + 0.5 ALD2 + 0.5 MCO3 + 0.5 HO2 + 0.25 MOH       ', & ! index 115
     ...
     '   HC5OO + MO2 --> 0.33 PCO + 0.25 ROH + 0.13 GLYC + 0.29 MGLY + 0.18 HAC + 0.25 MEK + 0.95 CH2O + 0', & ! index 118
     '    VRO2 + MO2 --> 0.25 ROH + 0.36 GLYC + 0.14 MGLY + 0.25 MEK + 0.89 CH2O + 0.36 MCO3 + 0.64 HO2 + ', & ! index 119
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '    PRN1 + MO2 --> 0.25 ROH + 0.25 RCHO + 1.25 CH2O + 0.5 ALD2 + 0.5 HO2 + NO2 + 0.25 MOH           ', & ! index 124
     ...
     '   NMAO3 + HO2 --> 0.15 POx + 0.39 PCO + 0.41 MAOP + 0.59 CH2O + 0.39 CO + 0.39 MO2 + 0.15 O3 + 0.44', & ! index 134
     '     PRPE + OH --> PO2                                                                              ', & ! index 135
     '     PRPE + O3 --> LOx + 0.56 PCO + 0.1 CH4 + 0.12 CH3CHOO + 0.12 CH2OO + 0.5 CH2O + 0.5 ALD2 + 0.56', & ! index 136
     ...
     '     GLYC + OH --> 0.361 CO2 + 0.505 PCO + 0.134 GLYX + 0.134 HCOOH + 0.732 CH2O + 0.505 CO + 0.773 ', & ! index 141
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '   R4O2 + MCO3 --> 0.05 A3O2 + 0.18 B3O2 + 0.32 ACET + 0.32 ETO2 + 0.13 RCHO + 0.19 MEK + 0.32 ALD2 ', & ! index 207
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     ...
     '   R4N1 + MCO3 --> 0.3 R4O2 + 0.57 RCHO + 0.39 CH2O + 0.75 ALD2 + MO2 + NO2                         ', & ! index 215
     ...
     '   ISOPNB + O3 --> 0.36 CO2 + 0.64 LOx + 0.21 PCO + 0.21 MVKN + 0.42 PROPNN + 0.32 MACRN + 0.16 HCOO', & ! index 238
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_8 = (/ &
     ...
     '      HOBr + O --> LOx + BrO + OH                                                                   ', & ! index 253
     '       O + HBr --> LOx + Br + OH                                                                    ', & ! index 254
     '      BrO + OH --> LOx + Br + HO2                                                                   ', & ! index 255
     '      Br + NO3 --> BrO + NO2                                                                        ', & ! index 256
     '     CH2O + Br --> PCO + CO + HO2 + HBr                                                             ', & ! index 257
     '     ALD2 + Br --> MCO3 + HBr                                                                       ', & ! index 258
     '     ACET + Br --> ATO2 + HBr                                                                       ', & ! index 259
     '     C2H6 + Br --> ETO2 + HBr                                                                       ', & ! index 260
     '     C3H8 + Br --> A3O2 + HBr                                                                       ', & ! index 261
     '      Br + NO2 --> BrNO2                                                                            ', & ! index 262
     '     BrO + NO2 --> BrNO3                                                                            ', & ! index 263
     '    CHBr3 + OH --> 3 Br                                                                             ', & ! index 264
     '   CH2Br2 + OH --> 2 Br                                                                             ', & ! index 265
     '    CH3Br + OH --> Br + HO2 + H2O                                                                   ', & ! index 266
     '     H2O + O1D --> LOx + 2 OH                                                                       ', & ! index 267
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_9 = (/ &
     ...
     '     CH4 + O1D --> LOx + LCH4 + CH2O + H2                                                           ', & ! index 274
     '     CH4 + O1D --> LOx + LCH4 + H + CH2O + HO2                                                      ', & ! index 275
     '        O + O2 --> O3                                                                               ', & ! index 276
     '        O3 + O --> 2 LOx + 2 O2                                                                     ', & ! index 277
     '       OH + H2 --> H + H2O                                                                          ', & ! index 278
     '        O + OH --> LOx + H + O2                                                                     ', & ! index 279
     '       O + HO2 --> LOx + OH + O2                                                                    ', & ! index 280
     '      O3 + O1D --> 2 LOx + 2 O2                                                                     ', & ! index 281
     '      O3 + O1D --> 2 O + O2                                                                         ', & ! index 282
     '       OCS + O --> LOx + PCO + SO2 + CO                                                             ', & ! index 283
     '      OCS + OH --> CO2 + SO2                                                                        ', & ! index 284
     '       O + NO2 --> 2 LOx + NO + O2                                                                  ', & ! index 285
     '       O + NO3 --> 2 LOx + NO2 + O2                                                                 ', & ! index 286
     '        NO + O --> NO2                                                                              ', & ! index 287
     '       O + NO2 --> NO3                                                                              ', & ! index 288
     ...
     '     O1D + HCl --> 0.67 LOx + 0.24 H + 0.09 O + 0.67 Cl + 0.67 OH + 0.24 ClO + 0.09 HCl             ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_10 = (/ &
     '     O1D + HBr --> 0.65 LOx + 0.15 H + 0.15 BrO + 0.65 Br + 0.2 O + 0.65 OH + 0.2 HBr               ', & ! index 301
     '     Cl2 + O1D --> 0.25 Cl2 + 0.25 O + 0.75 Cl + 0.75 ClO                                           ', & ! index 302
     '    CCl4 + O1D --> 0.14 CCl4 + 0.14 O + 2.58 Cl + 0.86 ClO                                          ', & ! index 303
     ...
     '  HCFC22 + O1D --> 0.17 LOx + 0.28 HCFC22 + 0.28 O + 0.17 Cl + 0.55 ClO                             ', & ! index 307
     '   CFC11 + O1D --> 0.12 CFC11 + 0.12 O + 1.76 Cl + 0.88 ClO                                         ', & ! index 308
     '   CFC12 + O1D --> 0.14 CFC12 + 0.14 O + 1.72 Cl + 0.86 ClO                                         ', & ! index 309
     '   H1211 + O1D --> 0.36 H1211 + 0.31 BrO + 0.33 Br + 0.36 O + 0.31 Cl + 0.33 ClO                    ', & ! index 310
     '   H1301 + O1D --> 0.59 H1301 + 0.41 BrO + 0.59 O                                                   ', & ! index 311
     'HCFC141b + O1D --> 0.31 HCFC141b + 0.31 O + 0.69 Cl + 0.69 ClO                                      ', & ! index 312
     'HCFC142b + O1D --> 0.26 HCFC142b + 0.26 O + 0.74 ClO                                                ', & ! index 313
     ' HCFC123 + O1D --> 0.21 HCFC123 + 0.21 O + 0.79 Cl + 0.79 ClO                                       ', & ! index 314
     '  CFC113 + O1D --> 0.25 CFC113 + 0.25 O + 1.5 Cl + 0.75 ClO                                         ', & ! index 315
     '  CFC114 + O1D --> 0.25 CFC114 + 0.25 O + 0.75 Cl + 0.75 ClO                                        ', & ! index 316
     '  CFC115 + O1D --> 0.7 CFC115 + 0.7 O + 0.3 ClO                                                     ', & ! index 317
     '   H2402 + O1D --> 0.25 H2402 + 0.75 BrO + 0.75 Br + 0.25 O                                         ', & ! index 318
     '      Cl2 + OH --> POx + HOCl + Cl                                                                  ', & ! index 319
     '     MO2 + ClO --> LOx + ClOO + CH2O + HO2                                                          ', & ! index 320
     '      OH + ClO --> LOx + HO2 + Cl                                                                   ', & ! index 321
     '      OH + ClO --> LOx + HCl + O2                                                                   ', & ! index 322
     '     OClO + OH --> LOx + HOCl + O2                                                                  ', & ! index 323
     '    Cl2O2 + OH --> LOx + ClOO + HOCl                                                                ', & ! index 324
     '      OH + HCl --> Cl + H2O                                                                         ', & ! index 325
     '     HOCl + OH --> H2O + ClO                                                                        ', & ! index 326
     '    ClNO2 + OH --> POx + HOCl + NO2                                                                 ', & ! index 327
     '    ClNO3 + OH --> POx + HOCl + NO3                                                                 ', & ! index 328
     '    CH3Cl + OH --> HO2 + Cl + H2O                                                                   ', & ! index 329
     '   CH2Cl2 + OH --> HO2 + 2 Cl                                                                       ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_11 = (/ &
     '    CHCl3 + OH --> HO2 + 3 Cl                                                                       ', & ! index 331
     '  CH3CCl3 + OH --> 3 Cl + H2O                                                                       ', & ! index 332
     '   HCFC22 + OH --> Cl + H2O                                                                         ', & ! index 333
     ' HCFC141b + OH --> 2 Cl + H2O                                                                       ', & ! index 334
     ' HCFC142b + OH --> Cl + H2O                                                                         ', & ! index 335
     '  HCFC123 + OH --> 2 Cl + H2O                                                                       ', & ! index 336
     '      CH4 + Cl --> LCH4 + MO2 + HCl                                                                 ', & ! index 337
     '     CH2O + Cl --> PCO + CO + HO2 + HCl                                                             ', & ! index 338
     '       O3 + Cl --> ClO + O2                                                                         ', & ! index 339
     '       Cl + H2 --> H + HCl                                                                          ', & ! index 340
     '     H2O2 + Cl --> HO2 + HCl                                                                        ', & ! index 341
     '      HO2 + Cl --> HCl + O2                                                                         ', & ! index 342
     '      HO2 + Cl --> POx + OH + ClO                                                                   ', & ! index 343
     '       O + ClO --> 2 LOx + Cl + O2                                                                  ', & ! index 344
     '     HO2 + ClO --> HOCl + O2                                                                        ', & ! index 345
     '      NO + ClO --> Cl + NO2                                                                         ', & ! index 346
     '     NO2 + ClO --> ClNO3                                                                            ', & ! index 347
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_12 = (/ &
     ...
     '    CH3Cl + Cl --> PCO + CO + HO2 + 2 HCl                                                           ', & ! index 362
     '   CH2Cl2 + Cl --> PCO + CO + HO2 + 2 Cl + HCl                                                      ', & ! index 363
     '    CHCl3 + Cl --> PCO + CO + HO2 + 3 Cl + HCl                                                      ', & ! index 364
     '    HCOOH + Cl --> CO2 + H2O + HCl                                                                  ', & ! index 365
     '      MO2 + Cl --> POx + CH2O + HO2 + ClO                                                           ', & ! index 366
     '       MP + Cl --> MO2 + HCl                                                                        ', & ! index 367
     '     C2H6 + Cl --> ETO2 + HCl                                                                       ', & ! index 368
     '     ETO2 + Cl --> POx + ALD2 + HO2 + ClO                                                           ', & ! index 369
     '      Cl + MOH --> CH2O + HO2 + HCl                                                                 ', & ! index 370
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_13 = (/ &
     ...
     '    HC5OO + NO --> POx + 0.09 PCO + 0.17 MOBA + 0.29 DHMOB + 0.216 GLYX + 0.234 GLYC + 0.234 MGLY + ', & ! index 412
     '    HC5OO + NO --> POx + HNO3                                                                       ', & ! index 413
     '   HC5OO + HO2 --> 0.1 IAP + 0.9 GLYC + 0.9 MGLY + 0.9 HO2 + 0.9 OH                                 ', & ! index 414
     ...
     ' ISOPNDO2 + NO --> 1.394 POx + 0.27 DHDN + 0.21 ETHLN + 0.075 MVKN + 0.3 PROPNN + 0.057 ISOPNDO2 + 0', & ! index 417
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_14 = (/ &
     '     ISNP + OH --> 0.388 LOx + 0.193 ISOPNDO2 + 0.612 R4N1 + 0.193 ISOPNBO2 + 0.612 OH              ', & ! index 421
     ...
     '    DIBOO + NO --> POx + 0.48 GLYX + 0.52 GLYC + 0.52 MGLY + 0.48 HAC + HO2 + NO2                   ', & ! index 429
     '    DIBOO + NO --> POx + HNO3                                                                       ', & ! index 430
     '   DIBOO + HO2 --> 0.85 R4P + 0.072 GLYX + 0.078 GLYC + 0.078 MGLY + 0.072 HAC + 0.15 HO2 + 0.15 OH ', & ! index 431
     ...
     '  MACROO + H2O --> H2O2 + MACR                                                                      ', & ! index 449
     '    MVKOO + CO --> LCO + MVK                                                                        ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_15 = (/ &
     ...
     '  MGLYOO + H2O --> H2O2 + MGLY                                                                      ', & ! index 459
     ...
     ' CH3CHOO + H2O --> H2O2 + ALD2                                                                      ', & ! index 470
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_16 = (/ &
     ...
     '     MTPA + O3 --> LOx + 0.14 PCO + 0.02 H2O2 + 0.62 KO2 + 0.65 RCHO + 0.53 MEK + 0.14 CO + 0.1 HO2 ', & ! index 495
     '     MTPO + O3 --> LOx + 0.14 PCO + 0.02 H2O2 + 0.62 KO2 + 0.65 RCHO + 0.53 MEK + 0.14 CO + 0.1 HO2 ', & ! index 496
     '    MTPA + NO3 --> 2 LOx + 0.9 OLND + 0.1 OLNN                                                      ', & ! index 497
     '    MTPO + NO3 --> 2 LOx + 0.9 OLND + 0.1 OLNN                                                      ', & ! index 498
     '     LIMO + OH --> LIMO2                                                                            ', & ! index 499
     '     LIMO + O3 --> LOx + 0.14 PCO + 0.02 H2O2 + 0.01 HCOOH + 0.42 KO2 + 0.16 ETO2 + 0.46 PRPE + 0.04', & ! index 500
     ...
     '   LIMO2 + NO3 --> LOx + 0.385 PRPE + 0.385 CH2O + 0.615 MACR + HO2 + NO2                           ', & ! index 506
